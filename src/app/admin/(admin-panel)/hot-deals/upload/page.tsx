...
const HotDealsUploadPage: React.FC = () => {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('badge', 'HOT_DEAL');
  ...
  return (
    <div className={styles.uploadPage}>
      <div className={styles.uploadCard}>
        <h2 className={styles.uploadTitle}>🔥 인기특가 상품 등록</h2>
        <p className={styles.uploadSubtitle}>
          새로운 특가 상품 정보를 입력해주세요.
        </p>
...
export default HotDealsUploadPage;
