...
const HotDealsManagePage: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      const res = await fetch('/api/products?badge=HOT_DEAL');
  ...
  return (
    <div className={styles.managePage}>
      <div className={styles.manageHeader}>
        <h2 className={styles.manageTitle}>🔥 인기특가 관리</h2>
        <div>
...
export default HotDealsManagePage;
