...
import styles from "../../products/manage/ProductManage.module.css";
import { Product } from "@/types/product";

const TopRankingManagePage: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      const res = await fetch("/api/products?badge=TOP_RANKING");
  ...
  return (
    <div className={styles.managePage}>
      <div className={styles.manageHeader}>
        <h2 className={styles.manageTitle}>🏆 TOP 랭킹 관리</h2>
        <div>
...
export default TopRankingManagePage;
